use utils::{
    ...
    point::MapPoint, polygon::{Point, Line},
};
...
fn run2(input_file: &str) {
    ...
    for instruction in instructions {
        ...
        let direction = instruction.direction.into();
        let steps = instruction.steps as i64;
        // let start = position;

        position.move_steps_in_direction(steps, direction);
